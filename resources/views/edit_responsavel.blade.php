...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <form class="ui form" action="{{ route('responsavel.update', $responsavel->id) }}" method="post">
                @csrf
                @method('PATCH')
                ...
                <div class="field">
                    ...
                    <select id="responsavel" name="cod_responsavel" class="ui search dropdown">
                        <option value="{{$responsavel->cod_responsavel}}" selected="true">{{$responsavel->nome_responsavel}}</option>
                    </select>
                </div>
                <div class="field">
                    <label>aluno</label>
                    <select id="aluno" name="cod_aluno" class="ui search dropdown">
                        <option value="{{$responsavel->cod_aluno}}" selected="true">{{$responsavel->nome_aluno}}</option>
                    </select>
                </div>
